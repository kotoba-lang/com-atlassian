...
- **Schema:** Defined in `schema/atlassian.kotoba-schema`.
- **Execution:** Runs in `Py Kotodama WASM`, intercepting inbound REST requests.

## Provenance

Relocated 2026-07-04 from `etzhayyim/root/20-actors/atlassian-compat` to
`kotoba-lang/com-atlassian` per the org-taxonomy library-placement rule (any
